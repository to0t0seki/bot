...
while True:
    ...
    client.place_order(symbol="GEEKUSDT", side="buy", order_type="limit", force="gtc", price=target_price, size=buy_amount)
    client.cancel_replace_order(symbol="GEEKUSDT", order_id=order_id, price=target_price, size=buy_amount)
    time.sleep(1)